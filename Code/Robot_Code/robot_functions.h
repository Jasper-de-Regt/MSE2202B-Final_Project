...
void followWall(int driveSpeed, char wallSide, int desiredDistance); // call to follow a wall. Example followWall(R, 15, 1600) will follow a wall on the right side, maintaining a distance of 15cm, at a speed of 1600
